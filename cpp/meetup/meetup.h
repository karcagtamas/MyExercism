...
namespace meetup
{
    ...
    {
    public:
        scheduler(boost::gregorian::date::month_type month, int year);
    ...
    private:
        ...
        boost::gregorian::date nth_weekday(boost::gregorian::greg_weekday weekday, int occurrence) const;

        boost::gregorian::date teenth(boost::gregorian::greg_weekday weekday) const;

        boost::gregorian::date last_weekday(boost::gregorian::greg_weekday weekday) const;
    };
