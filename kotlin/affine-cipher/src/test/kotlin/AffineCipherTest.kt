...
class AffineCipherTest {
    ...
    @Test
    fun `encode all letters`() = assertEquals(
    ...
    @Test
    fun `decode a sentence`() = assertEquals(
    ...
    @Test
    fun `decode all the letters`() = assertEquals(
        "thequickbrownfoxjumpsoverthelazydog",
        AffineCipher.decode("swxtj npvyk lruol iejdc blaxk swxmh qzglf", 17, 33)
    )

    @Test
    fun `decode with no spaces in input`() = assertEquals(
        "thequickbrownfoxjumpsoverthelazydog",
